...
export function buildValidationResultV2(): ValidationResultV2 {
  return {
    ...
    federal_allocation: {
      ...
      source_rows_count: 0,
      source_budget_rub: 0,
      allocated_budget_rub: 0,
      difference_rub: 0,
      geo_count: null,
      declared_geo_count: null,
      ready_geo_count: null,
      excluded_geo_count: null,
      denominator_policy_version: null,
      lmax: null,
      required_period_start: null,
      required_period_end: null,
