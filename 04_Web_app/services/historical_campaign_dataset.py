...
REASONS = {
    'OUT_OF_TRAINING_WINDOW': 'Кампания выходит за обучающий период; это ограничение текущей версии расчёта, а не утверждение об отсутствии данных панели',
    'PARTIAL_CHANNEL_COVERAGE': 'Часть бюджета относится к каналам без оценки в модели РТО',
    'PARTIAL_GEO_COVERAGE': 'Часть бюджета относится к географиям без параметров в исторической модели',
